...
function RekaChallengeSection() {
    const { eyebrow, subtitle, highlights, cards, cta } = rekaChallengeData
                ...
                <div className="overflow-hidden rounded-3xl border border-[#60a5fa]/15 bg-gradient-to-br from-[#eef6ff] via-[#fff7ed] to-[#eef6ff] shadow-md">
                    <div className="px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10">
                        ...
                        <div className="mx-auto max-w-3xl text-center">
                            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold tracking-[0.2em] text-black/50 uppercase shadow-sm">
                                <Sparkles className="text-dh-orange h-3.5 w-3.5" />
                                {eyebrow}
                            </div>

                            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl">
                                <span className="text-dh-orange">
                                    Reka Vision
                                </span>{" "}
                                Challenge
                            </h2>
                            ...
                            <div className="mt-7 grid gap-4 text-left md:grid-cols-3">
                                {highlights.map(item => (
                                    <div
                                        key={item.title}
                                        className="rounded-2xl border border-[#60a5fa]/15 bg-white/70 p-4 shadow-sm">
                            ...
                            <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-black/55 sm:text-base">
                                Full challenge details and judging criteria will
                                be released soon. API credits will be provided
                            ...
                            {cta && (
                                <div className="mt-5 flex justify-center">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="bg-dh-orange inline-flex items-center rounded-full px-5 py-2 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-md">
                                        {cta.label}
                                    </a>
                                </div>
                            )}
                                        ...
                                        <div
                                            ...
                                            <button
                                                ...
                                                <div className="min-w-0">
                                                    <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[#eef6ff] px-3 py-1 text-[11px] font-semibold tracking-wide text-[#0369a1] uppercase">
                                                        <Lightbulb className="h-3.5 w-3.5" />
                                                        Problem Area
                                                    </div>

                                                    <h3 className="text-base leading-snug font-bold text-black">
                                                        {card.area}
                                                    </h3>
                                                </div>
                                                                ...
                                                                {card.guidingQuestions.map(
                                                                    (
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <span className="bg-dh-orange mt-2 h-1.5 w-1.5 shrink-0 rounded-full" />
                                                                            <span>
                                                                                {
                                                                                    question
                                                                                }
                                ...
                                {cards.map(card => (
                                    <div
                                        ...
                                        <div className="mb-4 flex items-start justify-between gap-3">
                                            <div className="inline-flex items-center gap-2 rounded-full bg-[#eef6ff] px-3 py-1 text-xs font-semibold tracking-wide text-[#0369a1] uppercase">
                                                <Lightbulb className="h-3.5 w-3.5" />
                                                Problem Area
                                            </div>
                                        </div>
