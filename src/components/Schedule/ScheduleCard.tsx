...
function ScheduleCard({
  ...
  return (
    <div className="group relative flex w-full max-w-3xl items-center gap-4 md:gap-6">
      {/* Timeline dot */}
      ...
      {/* Left pill */}
      <div
        className={`relative z-20 flex min-h-15 w-37.5 shrink-0 items-center justify-center rounded-full px-4 text-center shadow-md transition-all duration-300 group-hover:scale-[1.03] md:w-55 ${
