      ...
      {props.active === "General" && (
        <div className="m-auto flex w-[325px] flex-col justify-center rounded-xl bg-[#81BFDA] sm:w-[600px] md:w-[750px]">
          ...
          <FAQCard
            ...
            answer={
              <>
                Our workshops are designed to be interactive and hands-on. From
                our experience, in-person sessions create a more focused
                learning environment where participants can actively
                participate, ask questions, and network with peers.
                <br />
                <br />
                Unlike virtual sessions, which can be prone to distractions and
                passive participation, in-person workshops encourage real-time
                discussions and a more immersive learning experience.
              </>
            }
          />
          <FAQCard
            ...
            answer={
              <>
                Between the Opening and Closing Ceremony, we will have Check-In
                sessions with our SummerBuild mentors for teams to meet and
                network with their mentors. This gives you an opportunity to
                learn from the mentors and exchange ideas, experiences and best
                practices.
                <br />
                <br />
                Whether you're looking for inspiration or feedback on your
                product, these sessions will provide a supportive environment to
                help you grow.
                <br />
                <br />
                Make the most of this opportunity to expand your network and
          ...
          <FAQCard
            ...
            answer={
              <>
                Yes, most of your team should attend the ceremonies, as we will
                be giving out swag during both opening and closing ceremonies.
                <br />
                <br />
                Furthermore, there will be a science-fair style judging during
                the closing ceremony for us to assign the levels of achievement
                to the groups, as well as award the special prizes.
              </>
            }
          />
          <FAQCard
