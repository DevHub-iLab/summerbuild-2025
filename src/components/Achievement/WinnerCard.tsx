        ...
        <div
            ...
            <div className="flex h-full flex-col">
                ...
                <div className="relative h-52 w-full overflow-hidden sm:h-60">
                    ...
                    {/* Award badge */}
                    <div className="absolute top-3 left-3 inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1.5 text-sm font-semibold text-[#1E1E1E] shadow-sm backdrop-blur-sm">
                    ...
                    {hasMultipleImages && (
                        <>
                            <button
                                ...
                                className="absolute top-1/2 left-3 flex -translate-y-1/2 items-center justify-center rounded-full bg-white/85 p-2 shadow transition hover:bg-white">
                                <ChevronLeft
                                    size={18}
                            ...
                            <button
                                ...
                                className="absolute top-1/2 right-3 flex -translate-y-1/2 items-center justify-center rounded-full bg-white/85 p-2 shadow transition hover:bg-white">
                                <ChevronRight
                                    size={18}
                                    className="text-[#1E1E1E]"
                                />
                ...
                <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-1 text-sm font-semibold tracking-[0.16em] text-black/45 uppercase">
                        Project: {projectName}
                    </p>
            ...
            {tags.map((tag) => (
              ...
              >
                {tag}
                    ...
                    {/* Team members */}
                    <div className="mt-5">
                        <h3 className="text-s font-semibold tracking-[0.14em] text-black uppercase">
                            Team Members
                        </h3>
