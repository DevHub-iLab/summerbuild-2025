  ...
  return (
    <section className="mt-20 px-5">
      ...
      <h3 className="mt-3 text-center text-lg text-[#1E1E1E]">
        Compete for top awards and special recognitions at the end of the
        programme!
      </h3>
            ...
            {allAwards.map((award) => (
              <SwiperSlide key={award.id}>
                <div className="px-2 pb-8">
                  <p className="mb-2 text-center text-sm font-semibold uppercase tracking-wide text-[#323854]">
                    {award.category}
                  </p>
                  <AchievementCard
                    color={award.color}
