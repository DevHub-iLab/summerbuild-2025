    ...
    extendedSection: {
        ...
        content: {
            ...
            link: {
                ...
                className:
                    "bg-linear-65 from-[#c0a0d4] via-[#ce8585] to-[#fcb045] bg-clip-text font-bold text-transparent underline",
            },
...
export const FAQTopicElements = {
    containerClassName:
        "m-auto flex w-[325px] flex-col justify-center rounded-xl bg-[#81BFDA] sm:w-[600px] md:w-[750px]",
    ...
    general: [
        ...
        },
        {
            ...
            answer: [
                "Between the Opening and Closing Ceremony, we will have Check-In sessions with our SummerBuild mentors for teams to meet and network with their mentors.",
        ...
        },
        {
            id: "general-5",
            question:
                "Do I need to attend for the opening and closing ceremonies?",
        ...
        },
        {
            ...
            answer: "We recommend all groups to have at least 2 virtual check-In sessions with your assigned mentor throughout the programme. One in the 1st week of June, the other in the 2nd week of June. These Check-In sessions offers a chance for you to get feedback on your product!",
        },
        {
            id: "general-7",
